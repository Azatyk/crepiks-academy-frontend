<template>
  <div class="trial">
    ...
    <p class="trial-text">
      В мини браузере ты увидишь результат выполнения кода, а автоматический
    ...
    testFunction(iframe) {
      ...
      if (heading && heading.innerHTML == "Hello, World!") {
        return {
          ...
          text:
            'В мини браузере ты можешь увидеть надпись "Hello, World!". Это и есть результат выполнения твоего кода.'
        };
      } else {
        return {
          status: "error",
