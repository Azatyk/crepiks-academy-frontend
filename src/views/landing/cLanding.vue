<template>
  <div class="landing__page">
    ...
    <div class="about-course">
      <div class="about-course__text">
        ...
        <div class="about-course__description">
          Курс будет проходить на нашей онлайн интерактивной платформе. Что
          значит интерактивный? Это значит, что вы будете писать код прямо в
          браузере, а проверять вас будет не учитель, а специальные
    ...
    <div class="about-ending">
      <div class="about-ending__images-container">
        <img
    ...
    <footer class="footer">
      <div class="footer__logo-social">
        <div class="footer__logo">Crepiks</div>
...
.about-ending__image-sertificate:hover {
  transform: rotateY(0deg) scale(1.3) translateX(30px);
}

.about-ending__image-sertificate:hover ~ .about-ending__image-landing {
  transform: rotateY(50deg) translateX(50px) scale(0.85);
}
...
.about-ending__image-landing:hover {
  transform: rotateY(0deg) scale(1.3) translateX(-30px);
}
